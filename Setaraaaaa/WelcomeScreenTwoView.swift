...
struct WelcomeScreenTwoView: View {
    var body: some View {
        VStack {
            VStack(spacing: 10) {
                VStack {
                    Image("welcomescreendua")
                        .resizable()
                        .scaledToFit()
...
struct WelcomeScreenTwoView_Previews: PreviewProvider {
    static var previews: some View {
        WelcomeScreenTwoView()
    }
}
